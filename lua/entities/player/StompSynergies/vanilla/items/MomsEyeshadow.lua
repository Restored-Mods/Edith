...
function MomsEyeshadow:OnStomp(player, stompDamage, bombLanding, forced, isStompPool)
	...
	if
		...
		or isStompPool.Pool3DollarBill
		or isStompPool.PoolFruitCake
		or isStompPool.PoolPlaydoughCookie
		or isStompPool.PoolFFEmojiGlases
	then
...
EdithRestored:AddCallback(
	...
	MomsEyeshadow.OnStomp,
	{
		...
		Pool3DollarBill = true,
		PoolFruitCake = true,
		PoolPlaydoughCookie = true,
		PoolFFEmojiGlases = true,
	}
)
